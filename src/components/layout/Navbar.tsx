      ...
      <motion.header
        ...
        style={{
          ...
          borderBottom: scrolled
            ? "1px solid rgba(108,140,165,0.12)"
            : "none",
        }}
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              style={{
                border: "1px solid rgba(108,140,165,0.45)",
                color: "#6C8CA5",
                letterSpacing: "0.1em",
              }}
              onMouseEnter={(e) => {
        ...
        {mobileOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full gap-8 pt-20">
              ...
              <motion.a
                href="tel:+905307456800"
                className="mt-6 flex items-center gap-3 px-8 py-3 text-sm font-semibold tracking-widest uppercase"
                style={{
                  border: "1px solid rgba(108,140,165,0.5)",
                  color: "#6C8CA5",
                }}
                initial={{ opacity: 0, y: 24 }}
                animate={{ opacity: 1, y: 0 }}
